...
Route::prefix('api/v1')->group(function () {
    ...
    Route::get('portal/usage', PortalUsageController::class);
    ...
    Route::match(['get', 'head', 'post'], 'webhook/telegram/mirror/{mirrorId}/{secret}', [WebhookController::class, 'mirror'])
        ->whereNumber('mirrorId')
        ->middleware(WebhookRateLimit::class.':ip');
