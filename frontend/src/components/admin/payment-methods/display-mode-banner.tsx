    ...
    >
      {canEditDisplayMode ? (
        <>
          ...
          <select
            className="flex h-8 min-w-[10rem] rounded-md border border-input bg-transparent px-2 text-sm"
            value={displayMode}
            onChange={(e) => onDisplayModeChange((e.target.value as CardsDisplayMode) || "list")}
          >
